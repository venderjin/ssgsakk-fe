    ...
    <>
      <header className="w-full bg-white">
        <div className="w-full flex justify-between items-center py-[8px] pl-[16px] pr-[10px] gap-2">
          ...
          <div className="flex items-center">
            <Image
              src="/images/home/chatbotLogo.png"
              alt="Chatbot"
              width={26}
              height={26}
              className="mr-[10px]"
      ...
      >
        ...
        <div className="py-[20px] px-[16px]">
          <p className="font-Pretendard text-[17px] text-black font-semibold">
            어떤 쇼핑을 원하시나요?
          </p>
          {homeShoppingmallSelectModalData[0].items.map(
            (item: {
              ...
              eventBoolean?: boolean | undefined;
              imgPath: string;
            }) => {
              return (
                <div
                  key={item.id}
                  className="flex flex-row  justify-between items-center py-[16px] border-b-[1px]"
                >
                  <div className="flex items-center gap-[10px]">
                    ...
                    <div>
                      <div className="flex flex-row gap-1">
                        <p className="font-Pretendard text-[14px] text-black font-semibold">
                          {item.title}
                        </p>
                        {item.eventBoolean && (
                          <div className="border-2 border-primary-red px-[4px]">
                            <p className="text-[11px] text-primary-red text-center">
                              EVENT
                            </p>
                          </div>
                        )}
                      </div>
                      <p className="font-Pretendard text-[13px] text-gray-400">
                        {item.subtitle}
                      </p>
                    </div>
                  </div>
              ...
              (item: {
                ...
                return (
                  <div key={item.id}>
                    ...
                    <p className="font-Pretendard text-[13px] text-[#222222] pt-[6px] whitespace-nowrap">
                      {item.title}
                    </p>
                  </div>
                );
