...
const ReviewEditor = () => {
    ...
    return (
        <div className="px-[15px]">
            <h3 className="text-primary-red text-[14px] font-bold text-left pt-[30px] pb-[10px]">상품의 어떤 점이 좋았나요?</h3>
            ...
            <div className="relative border border-[#222] bg-[#fff] rounded-[8px] mb-[28px] overflow-visible">
                ...
                <span className="absolute bottom-[-28px] right-[7px] text-[12px] text-[#969696]">
                    <em className="text-[#777] not-italic">{contentCount}</em> / 2000(10자 이상)
                </span>
