...
const ProductDetailInfo = ({ productDescription }: { productDescription: string }) => {
    ...
    return (
        <div className=" px-[20px] mb-[52px] border-t-[15px] border-t-[#f5f5f5] font-Pretendard">
            <div className="relative ml-[2px] mb-[15px] pt-[40px]">
                <h3 className="text-[19px] relative inline-block text-[#222222] pb-[4px] font-semibold">상세정보</h3>
                <div className="h-[1px] bg-[#cfcfcf]"></div>
            </div>

            <div className="overflow-hidden" ref={detailRef} style={{ maxHeight: detailMore ? "none" : `${detailHeight}px` }}>
                <div dangerouslySetInnerHTML={{ __html: productDescription }} />
            </div>

            {/* 상세정보 펼쳐보기 */}
            <div className="bg-white">
                <button onClick={toggleDetail} className="w-full h-[50px] text-[14px] flex items-center justify-center">
