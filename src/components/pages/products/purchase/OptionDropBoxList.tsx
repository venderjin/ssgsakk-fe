  ...
  const findOptionAndStockSeq = () => {
    const filteredOptions = optionStock.filter((option) => {
      ...
      if (selectedOption.length === 2) {
        return (
          option.explain === selectedOption[0] &&
          option.explain2 === selectedOption[1]
        );
      }
      if (selectedOption.length === 3) {
        return (
          option.explain === selectedOption[0] &&
          option.explain2 === selectedOption[1] &&
          option.explain3 === selectedOption[2]
        );
      }
    });
        ...
        <div key={idx}>
          ...
          <div
            ...
            style={{
              pointerEvents:
                idx > 0 &&
                (!selectedOption[idx - 1] || selectedOption[idx - 1] === "")
                  ? "none"
                  : "auto",
              opacity:
                idx > 0 &&
