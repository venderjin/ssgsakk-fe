  ...
  return (
    <>
      {alertDataState.isOpen && (
        <div className="font-Pretendard w-[80%] min-h-[15%] py-2 mx-auto z-[9999] fixed top-[20%] left-[50%] translate-x-[-50%] border border-slate-200 bg-white rounded-md shadow-xl">
          <div className="">
            ...
            {alertDataState.type === "alert" && (
              <div className="flex justify-center pb-[10px] w-full gap-4">
                <button
                  onClick={closeAlert}
                  className="rounded-[8px] w-[100px] h-[40px] text-white bg-blue-400"
                >
                  확인
                </button>
              </div>
            ...
            {alertDataState.type === "confirm" && (
              <div className="flex justify-center pb-[10px] w-full gap-4">
                <button
                  onClick={closeAlert}
                  className="rounded-[8px] w-[100px] h-[40px] bg-gray-200"
                >
                  취소
                </button>
                <button
