...
const Cart: React.FC<Props> = ({ width, height, disable }) => {
  return (
    <svg
    ...
    >
      <path
        d="M17 7.91006H5V8.91007H17V7.91006Z"
      ...
      />
      <path
        d="M15.9 13.91H6.1L3.4 4.91H1V3.91H4.2L6.9 12.91H15.1L17 6.81L18 7.01L15.9 13.91Z"
        fill={disable ? "gray" : "black"}
      />
    </svg>
  );
