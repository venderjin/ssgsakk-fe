    ...
    <Modal>
      <div className="h-[55px] w-full py-[8px] flex flex-row justify-center items-center">
        <div
          ...
          className="mx-[4px] w-[45px] flex-initial flex justify-center items-center"
        >
        ...
        <div className=" flex-1">
          <form className="relative w-full">
            ...
            <div className='"pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3'>
              {searchValueLength === 0 ? (
                <Image
                  src="/images/home/searchLogo.png"
                  alt="Search"
                  width={24}
                  height={24}
                />
        ...
        <div
          onClick={test}
          className="mx-[4px] w-[40px] flex-initial flex justify-center items-center"
        >
          <CartIcon />
        </div>
      </div>
